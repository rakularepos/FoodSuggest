...
public class GetFoodDiaryEntryResponse {
    ...
    public GetFoodDiaryEntryResponse(JSONObject jsonResponse, String profileId)
    {
        JSONObject foodEntry = jsonResponse.getJSONObject("food_entries").getJSONObject("food_entry");
        this.foodDiaryEntry = new FoodDiaryEntry(
                ...
                LocalDate.ofEpochDay(foodEntry.getLong("date_int")),
                profileId,
